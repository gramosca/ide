...
public class PessoaFisica {
	...
	public static void main(String[] args) {
		...
		/*
		 * no java, todas as variaveis precisam ser inicializadas, então está
		 * variavel relatório está recebendo atraves do objeto gererente o
		 * retorno da soma das contas correntes
		 */
